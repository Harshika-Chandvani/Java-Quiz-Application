...
public class startPage extends JFrame {
	...
	public startPage(String name) {
		...
		contentPane.add(lblNewLabel_4);
                ...
                JLabel lblNewLabel_5 = new JLabel("6. Brace yourself, this paper is not for the faint hearted.");
		lblNewLabel_5.setBounds(10, 167, 340, 14);
		...
		JLabel lblNewLabel_7 = new JLabel("4. Once you click on next button that question is saved and it cannot be selected.");
		lblNewLabel_7.setBounds(10, 134, 424, 14);
